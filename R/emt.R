...
#' For demoing the EMT, consider using \code{\link{demo_emt}()}.
#' For a standalone implementation of the EMT,
#' consider using \code{\link{standalone_emt}()}.
...
#' \code{"bOpt"} corresponds to the setting used in the original EMT paper.
...
#' \code{"BM"}, Bayes modal,
#' corresponds to the setting used in the original EMT paper.
...
#' which corresponds to the setting used in the original EMT paper.
...
#' @export
emt <- function(num_items = 20L,
                take_training = TRUE,
                label = "EMT",
                feedback = emt.feedback.no_score(),
                media_dir = "http://media.gold-msi.org/test_materials/EMT/v4",
